...
<footer class="py-5 bg-dark">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4 text-start text-white mb-4">
                <h4>Xe bán chạy</h4>
                <a href="#!" class="text-white d-block"> Toyota Vios</a>
                <a href="#!" class="text-white d-block"> Toyota Fortuner</a>
                <a href="#!" class="text-white d-block"> Toyota Innova</a>
                <a href="#!" class="text-white d-block"> Toyota Corolla Cross</a>
                <hr>
                <a href="#!" class="text-white d-block"> Honda CR-V</a>
                <a href="#!" class="text-white d-block"> Honda City</a>
                <a href="#!" class="text-white d-block"> Honda Civic</a>
                <a href="#!" class="text-white d-block"> Honda Accord</a>
                <hr>
                <a href="#!" class="text-white d-block"> Hyundai Accent</a>
                <a href="#!" class="text-white d-block"> Hyundai Tucson</a>
                <a href="#!" class="text-white d-block"> Hyundai Santa Fe</a>
                <a href="#!" class="text-white d-block"> Hyundai Elantra</a>
            </div>
