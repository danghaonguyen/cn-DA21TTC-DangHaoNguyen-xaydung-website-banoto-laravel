...
Route::get('/admin/home-dashboard', [DashboardController::class, 'showRevenueChart'])->name('admin.home-dashboard');
...
Route::get('/service/test-drive', [ServiceController::class, 'showtest'])->name('service.test-drive');

// Hiển thị form thêm tạo lịch lái thử cho khách hàng
Route::get('/admin/create/schedule/{id}', [ServiceController::class, 'create'])->name('admin.create-testdrive');

// Route lưu lịch lái thử và gửi email xong chuyển hướng về admin.list-testdrive.store
Route::post('/admin/create/schedule/{id}', [ServiceController::class, 'storeSchedule'])->name('admin.list-testdrive.store');

Route::get('/admin/view-testdrive', [ServiceController::class, 'viewSchedule'])->name('admin.view-testdrive');
...
Route::post('/admin/installments/send-email/{id}', [ServiceController::class, 'sendEmail'])->name('admin.list-installment.sendEmail');
