...
Route::get('/', function () {
    ...
    $articles = Article::all(); // Lấy tất cả sản phẩm từ cơ sở dữ liệu
...
// Route để hiển thị danh sách các đơn đăng ký lái thử
...
Route::get('/admin/view-orders/{orderId}', [OrderController::class, 'viewOrder'])->name('admin.view-orders');  // Xem chi tiết đơn hàng
